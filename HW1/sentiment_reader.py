...
def build_dicts():
    ...
    nr_pos = 0
    with codecs.open("C:/Users/19255/Documents/GitHub/Natural-Language-Processing/HW1/positive.review", 'r', 'utf8') as pos_file:
    ...
    nr_neg = 0
    with codecs.open("C:/Users/19255/Documents/GitHub/Natural-Language-Processing/HW1/negative.review", 'r', 'utf8') as neg_file:
